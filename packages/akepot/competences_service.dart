...
class CompetencesService extends PolymerElement with ChangeNotifier  {
  @reflectable @published List<Category> get categories => __$categories; List<Category> __$categories; @reflectable set categories(List<Category> value) { __$categories = notifyPropertyChange(#categories, __$categories, value); }
  @reflectable @published bool get signedin => __$signedin; bool __$signedin = false; @reflectable set signedin(bool value) { __$signedin = notifyPropertyChange(#signedin, __$signedin, value); }
  @reflectable @published String get hash => __$hash; String __$hash; @reflectable set hash(String value) { __$hash = notifyPropertyChange(#hash, __$hash, value); }
  ...
  @reflectable @published String get newlink => __$newlink; String __$newlink = ""; @reflectable set newlink(String value) { __$newlink = notifyPropertyChange(#newlink, __$newlink, value); }
  @reflectable @published bool get newuser => __$newuser; bool __$newuser = false; @reflectable set newuser(bool value) { __$newuser = notifyPropertyChange(#newuser, __$newuser, value); }
